        ...
        <>
            ...
            <div className="container d-flex flex-row flex-wrap justify-content-between">
                <div className="card mb-3" style={{"maxWidth": "20rem"}}>
                    ...
                    <div className="card-footer bg-transparent">You have created 123 Documents</div>
                </div>
                <div className="card mb-3" style={{"maxWidth": "20rem"}}>
                    ...
                    <div className="card-footer ">You share 123 Documents</div>
                </div>
                <div className="card mb-3" style={{"maxWidth": "20rem"}}>
                    ...
                    <div className="card-footer bg-transparent">12gb out of 15gb is used</div>
                </div>
            </div>
